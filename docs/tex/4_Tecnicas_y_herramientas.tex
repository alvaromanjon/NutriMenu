...
\imagen{git/repositorios_locales_y_remotos}{Un repositorio central y otro local, cada uno con distintos commits}{1}
...
\imagen{git/commits}{Distintos commits en un repositorio}{1}
...
\imagen{git/branches}{Ramas en un repositorio}{1}
...
\imagen{git/merge}{Diagrama de una operación merge básica}{1}
