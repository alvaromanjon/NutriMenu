...
\imagen{MVC/diagrama-mvc}{Cada componente interactúa con los otros dos en el patrón MVC \cite{easyappcode:mvc}}{0.9}
...
\imagen{Docker/docker_architecture}{Diagrama de cómo interactúan los elementos dentro de la arquitectura de Docker \cite{docker:overview-architecture}}{0.75}
...
\imagen{React/component_tree}{Cada componente dispone de su propio estado, y los componentes padre son capaces de enviar propiedades a los componentes hijo \cite{atomikod:react}}{0.75}
...
\imagen{git/repositorios_locales_y_remotos}{Los dos repositorios pueden llegar a estar en distintos puntos dentro de la misma rama \cite{git:git-basics}}{1}
...
\imagen{git/commits}{Cada commit va a ser hijo del commit anterior a este \cite{git:git-basics}}{1}
...
\imagen{git/branches}{A partir de un commit pueden surgir varias ramas distintas \cite{git:git-basics}}{1}
...
% TODO: Añadir algo sobre GitHub Actions %
