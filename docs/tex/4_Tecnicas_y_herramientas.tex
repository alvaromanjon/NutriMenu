...
\imagen{MVC/diagrama-mvc}{Interacción entre componentes en el patrón MVC \cite{easyappcode:mvc}}{0.9}
...
\imagen{Docker/docker_architecture}{Diagrama de interacción de los elementos dentro de la arquitectura Docker \cite{docker:overview-architecture}}{0.75}
...
\imagen{React/component_tree}{Diagrama de flujo de datos en el árbol de componentes \cite{atomikod:react}}{0.75}
...
\imagen{git/repositorios_locales_y_remotos}{Distintos estados entre el repositorio remoto y local \cite{git:git-basics}}{1}
...
\imagen{git/commits}{Diagrama de relación entre los distintos commits \cite{git:git-basics}}{1}
...
\imagen{git/branches}{Bifurcación entre dos ramas \cite{git:git-basics}}{1}
