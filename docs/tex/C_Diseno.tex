...
\begin{itemize}
	...
	\imagen{React/container_presentation_pattern}{Diagrama del patrón Contenedor/Presentacional en React \cite{openreplay:container-pattern}}{0.8}
	...
	\imagen{React/accessory_perforation}{Diagrama de la perforación de accesorios \cite{flexiple:provider-pattern}}{0.8}
	...
	\imagen{React/provider_pattern}{Diagrama del patrón Proveedor en React \cite{flexiple:provider-pattern}}{0.8}
...
La infraestructura de la aplicación consta de 3 servicios, que son el \textit{frontend}, el \textit{backend} (API REST) y la base de datos, los cuales se encuentran conectados entre ellos (figura \ref{fig:Docker/infrastructure_diagram}). 
...
\imagen{Docker/infrastructure_diagram}{Diagrama de la infraestructura en Docker Compose}{0.75}