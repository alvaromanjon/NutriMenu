...
\begin{apiRoute}{get}{/locales}{Devuelve todos los locales existentes}
	...
	\begin{routeParameter}
		...
		\routeParamItem{nombre}{Devuelve todos los locales de una empresa cuyo nombre contengan el valor pasado por parámetro (se debe usar junto al parámetro id\_empresa)}
