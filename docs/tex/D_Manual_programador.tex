...
\imagen{Docker/docker_error_wsl}{Error de instalación al no tener WSL instalado}{0.8}
...
\imagen{Nutritionix/control_panel}{Panel de control de Nutritionix}{0.8}
...
\imagen{Nutritionix/keys}{Panel de API Keys de Nutritionix}{0.8}
...
\imagen{Testing/user_not_exists}{Mensaje de que no existe el usuario indicado}{0.8}

\item \textbf{Comprobación de que la contraseña es incorrecta}: Esta comprobación se puede encontrar al iniciar sesión.

\imagen{Testing/incorrect_password}{Mensaje de que la contraseña introducida es incorrecta}{0.8}
...
\imagen{Testing/passwords_dont_match}{Mensaje de que las contraseñas no coinciden}{0.8}
...
\imagen{Testing/required_value}{Mensaje de que el valor es requerido}{0.8}
...
\imagen{Testing/repeated_value}{Mensaje de que el valor se ha repetido}{0.8}
...
\imagen{Testing/alimento_exists}{Mensaje de que el alimento ya existe}{0.8}
